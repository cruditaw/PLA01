...
public class LocalBrowseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PersonDbModel dbHelper = new PersonDbModel(this); // model init
        ...
        ((Button) findViewById(R.id.btnAddNew)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(LocalBrowseActivity.this, CreateOrEditActivity.class);
    ...
    private Builder buildDeleteDialog() {
        Builder builder = new Builder(LocalBrowseActivity.this);
